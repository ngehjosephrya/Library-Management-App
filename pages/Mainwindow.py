...
ui,_ = loadUiType('template/library.ui')
...
class MainApp(QMainWindow , ui):
    ...
    def Handel_Buttons(self):
        ...
        self.pushButton_19.clicked.connect(self.Export_Day_Operations)
        self.pushButton_17.clicked.connect(self.Export_Books)
        self.pushButton_18.clicked.connect(self.Export_Clients)
